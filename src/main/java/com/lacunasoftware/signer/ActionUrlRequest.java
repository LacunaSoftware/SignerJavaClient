...
public class ActionUrlRequest {
  ...
  public ActionUrlRequest identifier(String identifier) {
   ...
   /**
   * The identifier (CPF) of the participant to whom you want to get the ticket.
   * @return identifier
  **/
  @Schema(description = "The identifier (CPF) of the participant to whom you want to get the ticket.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ActionUrlRequest actionUrlRequest = (ActionUrlRequest) o;
    return Objects.equals(this.identifier, actionUrlRequest.identifier) &&
        Objects.equals(this.emailAddress, actionUrlRequest.emailAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, emailAddress);
  }
