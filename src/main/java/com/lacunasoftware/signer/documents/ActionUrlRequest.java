...
public class ActionUrlRequest {
   ...
   * @return identifier
  **/
  @Schema(description = "The identifier (CPF in Brazil or Cédula de Identidad in Ecuador) of the participant to whom you want to get the ticket.")
  ...
  public ActionUrlRequest emailAddress(String emailAddress) {
   ...
   * @return emailAddress
  **/
  @Schema(description = "The email of the participant to whom you want to get the ticket.")
  ...
  public ActionUrlRequest requireEmailAuthentication(Boolean requireEmailAuthentication) {
   ...
   * @return requireEmailAuthentication
  **/
  @Schema(description = "If action is an electronic signature and this parameter is set to true, requires e-mail authentication with code in order to complete the signature.")
  public Boolean isRequireEmailAuthentication() {
    return requireEmailAuthentication;
  }

  public void setRequireEmailAuthentication(Boolean requireEmailAuthentication) {
    this.requireEmailAuthentication = requireEmailAuthentication;
  }
  ...
  public String toString() {
    ...
    sb.append("class ActionUrlRequest {\n");
