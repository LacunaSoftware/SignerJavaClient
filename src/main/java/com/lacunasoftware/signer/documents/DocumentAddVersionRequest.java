...
public class DocumentAddVersionRequest {
  ...
  **/
  @Schema(description = "")
  public FileUploadModel getFile() {
    return file;
  }

  public void setFile(FileUploadModel file) {
    this.file = file;
  }

  public DocumentAddVersionRequest disablePendingActionNotifications(Boolean disablePendingActionNotifications) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class DocumentAddVersionRequest {\n");
