...
public class InvoiceClosedModel {
  ...
  **/
  ...
  public InvoiceClosedModel invoiceTotals(List<InvoiceTotalModel> invoiceTotals) {
  ...
  public InvoiceClosedModel addInvoiceTotalsItem(InvoiceTotalModel invoiceTotalsItem) {
    if (this.invoiceTotals == null) {
      this.invoiceTotals = new ArrayList<InvoiceTotalModel>();
    }
  ...
  **/
  @Schema(description = "")
  public List<InvoiceTotalModel> getInvoiceTotals() {
    return invoiceTotals;
  }

  public void setInvoiceTotals(List<InvoiceTotalModel> invoiceTotals) {
    this.invoiceTotals = invoiceTotals;
  }
