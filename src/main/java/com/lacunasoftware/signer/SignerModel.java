...
public class SignerModel {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(subjectName, emailAddress, issuerName, identifier, companyName, companyIdentifier, isElectronic, signingTime, certificateThumbprint, attributeCertificates, validationResults);
  }
