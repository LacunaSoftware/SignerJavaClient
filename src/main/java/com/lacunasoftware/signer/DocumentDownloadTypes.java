 ...
 */
@JsonAdapter(DocumentDownloadTypes.Adapter.class)
public enum DocumentDownloadTypes {
  ...
  DocumentDownloadTypes(String value) {
    this.value = value;
  }
  ...
  public static DocumentDownloadTypes fromValue(String text) {
  ...
  public static class Adapter extends TypeAdapter<DocumentDownloadTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final DocumentDownloadTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DocumentDownloadTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DocumentDownloadTypes.fromValue(String.valueOf(value));
    }
  }
}
