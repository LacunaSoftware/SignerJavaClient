...
/**
 * Gets or Sets DocumentTicketType
 */
@JsonAdapter(DocumentTicketType.Adapter.class)
public enum DocumentTicketType {
  ...
  public static DocumentTicketType fromValue(String text) {
  ...
  public static class Adapter extends TypeAdapter<DocumentTicketType> {
    @Override
    public void write(final JsonWriter jsonWriter, final DocumentTicketType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DocumentTicketType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DocumentTicketType.fromValue(String.valueOf(value));
    }
  }
}
