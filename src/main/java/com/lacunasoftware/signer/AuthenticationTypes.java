 ...
 */
@JsonAdapter(AuthenticationTypes.Adapter.class)
public enum AuthenticationTypes {
  ...
  public static AuthenticationTypes fromValue(String text) {
  ...
  public static class Adapter extends TypeAdapter<AuthenticationTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuthenticationTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuthenticationTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuthenticationTypes.fromValue(String.valueOf(value));
    }
  }
}
