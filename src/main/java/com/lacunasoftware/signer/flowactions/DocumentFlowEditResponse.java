...
public class DocumentFlowEditResponse {
  ...
  public DocumentFlowEditResponse rectifiedParticipants(List<RectifiedParticipantModel> rectifiedParticipants) {
    this.rectifiedParticipants = rectifiedParticipants;
    return this;
  }

  public DocumentFlowEditResponse addRectifiedParticipantsItem(RectifiedParticipantModel rectifiedParticipantsItem) {
    if (this.rectifiedParticipants == null) {
      this.rectifiedParticipants = new ArrayList<RectifiedParticipantModel>();
    }
    this.rectifiedParticipants.add(rectifiedParticipantsItem);
    return this;
  }

   /**
   * Get rectifiedParticipants
   * @return rectifiedParticipants
  **/
  @Schema(description = "")
  public List<RectifiedParticipantModel> getRectifiedParticipants() {
    return rectifiedParticipants;
  }

  public void setRectifiedParticipants(List<RectifiedParticipantModel> rectifiedParticipants) {
    this.rectifiedParticipants = rectifiedParticipants;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentFlowEditResponse flowActionsDocumentFlowEditResponse = (DocumentFlowEditResponse) o;
    return Objects.equals(this.rectifiedParticipants, flowActionsDocumentFlowEditResponse.rectifiedParticipants);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rectifiedParticipants);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentFlowEditResponse {\n");
    
    sb.append("    rectifiedParticipants: ").append(toIndentedString(rectifiedParticipants)).append("\n");
    sb.append("}");
    return sb.toString();
  }
