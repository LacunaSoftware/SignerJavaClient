...
public class UploadBytesRequest {
  ...
  public UploadBytesRequest bytes(byte[] bytes) {
    this.bytes = bytes;
    return this;
  }
   ...
   * @return bytes
  **/
  @Schema(required = true, description = "The file bytes encoded in Base 64 format.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UploadBytesRequest uploadsUploadBytesRequest = (UploadBytesRequest) o;
    return Arrays.equals(this.bytes, uploadsUploadBytesRequest.bytes);
  }
