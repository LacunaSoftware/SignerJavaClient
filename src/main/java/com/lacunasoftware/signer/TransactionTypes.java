 ...
 */
@JsonAdapter(TransactionTypes.Adapter.class)
public enum TransactionTypes {
  ...
  public static TransactionTypes fromValue(String text) {
  ...
  public static class Adapter extends TypeAdapter<TransactionTypes> {
    @Override
    public void write(final JsonWriter jsonWriter, final TransactionTypes enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TransactionTypes read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TransactionTypes.fromValue(String.valueOf(value));
    }
  }
}
